...
const HistoryPage = () => {
    ...
    const historyCards = [
        ...
        { id: 2, era: "1400s",   region: "Ottoman Empire",      title: "Coffee in the Arab World",           description: "Coffee spread across the Islamic world, becoming central to social gatherings. The first coffeehouses opened in Mecca and Cairo, becoming vibrant centers of intellectual exchange.", highlight: "Coffeehouse Revolution" },
        { id: 3, era: "1600s",   region: "European Courts",     title: "Arrival in Europe",    description: "Coffee arrived in Europe through Venetian merchants. Despite initial skepticism from the Church, it captivated the elite and became a symbol of enlightenment and progress.", highlight: "European Awakening" },
        { id: 4, era: "1700s",   region: "Colonial Americas",   title: "Global Expansion and Colonization",      description: "European colonizers planted coffee across the Caribbean and Central America. These regions would become the world's primary coffee producers for centuries to come.", highlight: "Global Cultivation" },
        { id: 5, era: "1800s",   region: "Industrial Age",      title: "Rise of Coffee Culture", description: "The espresso machine was invented in Italy, revolutionizing how coffee was prepared and consumed. Speed and precision became the hallmarks of modern coffee culture.", highlight: "Birth of Espresso" },
        { id: 6, era: "1900s",   region: "Modern World",        title: "The Craft",          description: "Coffee evolved from a commodity to an art form. Baristas became artisans, and quality obsession drove a worldwide third-wave movement celebrating origin and technique.", highlight: "Specialty Coffee Era" }
    ];
